...
LOCAL_APPS = [
    ...
    "news_feed_content.users.apps.UsersConfig",
]
...
MIGRATION_MODULES = {"sites": "news_feed_content.contrib.sites.migrations"}
...
ADMINS = [("""Krishna Madhavan""", "madhavank@who.int")]
...
SPECTACULAR_SETTINGS = {
    "TITLE": "News Feed Content Aggregation API",
    "DESCRIPTION": "Documentation of API endpoints of News Feed Content Aggregation",
    "VERSION": "1.0.0",
